...
import { extractApiData, getUserDisplayName } from '../utils/shop';
      ...
      try {
        ...
        setErrorMessage(
          error.response?.data?.message ||
            'Cannot get current admin information.'
        );
        clearAuthSession();
      } finally {
        setLoading(false);
        ...
        <div className="mx-auto max-w-5xl overflow-hidden rounded-[36px] border border-white/70 bg-white shadow-2xl shadow-slate-900/10">
            ...
            <div className="mt-5 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm font-semibold uppercase tracking-[0.28em] text-orange-300">
                    {user?.role}
                  </p>
                </div>
              </div>
          ...
          <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[1fr_0.9fr]">
            <div className="rounded-[28px] border border-slate-200 bg-slate-50 p-6">
              <h2 className="text-2xl font-bold text-slate-950">Admin Details</h2>
              <div className="mt-6 space-y-4">
                ...
                <div className="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-slate-500">Verification</p>
            ...
            <div className="rounded-[28px] border border-slate-200 bg-white p-6">
              <h2 className="text-2xl font-bold text-slate-950">Next Step</h2>
              <div className="mt-6 rounded-3xl border border-emerald-100 bg-emerald-50 p-5">
                <div className="flex items-center gap-3 text-emerald-700">
                  <CheckCircleFilled />
                  <p className="font-bold">
                    Admin dashboard features will be developed later.
                  </p>
                </div>
                <p className="mt-2 text-sm leading-7 text-emerald-700/80">
                  This page only confirms that admin redirect and role-based protection
                  are wired correctly to the backend authentication flow.
                </p>
              </div>
            </div>
          </div>
